...
namespace UltimateVinicula
{
    public partial class formEmail : Form
    {
        ...
        //INSERT INTO DB
        private void add(string propriedade, string email)
        {
            //sql stmt
            string sql = "INSERT INTO `emails` (`idEmail`,`Contato_Propriedade_Nome`, `Email`) VALUES(NULL,'" + propriedade + "', '" + email + "')";
        ...
        //ADD TO DGVIEW
        private void populate(int id, String propriedade, String email)
        {
            dataGridView1.Rows.Add(id, propriedade, email);
        }
        ...
        //update db
        private void update(string propriedade, string email, int id)
        {
            //sql stmt

            //string sql = "UPDATE propriedade SET Nome ='" + nome + "',Administrador='" + administrador + "'WHERE NOME =" + nome + "";
            string sql = "UPDATE `emails` SET `Contato_Propriedade_Nome` = '" + propriedade + "', `Email` = '" + email + "' WHERE `emails`.`idEmail` = '" + id + "'";
            cmd = new MySqlCommand(sql, conexao);
        ...
        {
            //sql stnt
            string sql = "DELETE FROM `emails` WHERE `emails`.`idEmail` = \'" + id + "\'";
            cmd = new MySqlCommand(sql, conexao);
